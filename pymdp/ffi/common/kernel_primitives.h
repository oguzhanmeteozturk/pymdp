...
// `ensure_at_least` and `ScratchBuffer<T>` live in common/scratch_arena.h
// (transitively included above) and are part of the public surface of this
// header for back-compat with existing call sites.
